...
"""
        ...
        activation_message_text = (
            "📢 مرحبًا عزيزي!  للوصول إلى محتوى البوت،  يجب أولًا تفعيل بوت التمويل .\n\n"
            "🔰 خطوات التفعيل:\n\n"
            "1️⃣ اضغط على الرابط في الأسفل للذهاب إلى بوت التمويل.\n"
            "2️⃣ فعّل بوت التمويل واشترك في جميع القنوات المطلوبة❗️.\n"
            "3️⃣ بعد الاشتراك في جميع القنوات ، ستصلك رسالة من بوت التمويل تؤكد التفعيل.\n"
            "4️⃣ قم بإعادة  (تحويل) هذه الرسالة إلى هنا كما هي – بدون تعديل أو نسخ بعد تحويل الرسالة سيتم قبولك تلقائيًا .\n\n"
            "👇 اضغط هنا لتفعيل بوت التمويل:\n"
            f"🔗 {FINANCE_BOT_LINK_V1}" # الرابط هنا
        )
        bot.send_message(
            user_id,
...
def handle_v1(message):
    ...
    "4️⃣ قم بإعادة (تحويل) رسالة التفعيل إلى هنا – بدون نسخ أو تعديل، بعد تحويل الرسالة سيتم قبولك تلقائيًا.\n\n"
    "👇 اضغط هنا لتفعيل بوت التمويل:\n"
